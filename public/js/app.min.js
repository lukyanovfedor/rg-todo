...
!function(e,t,n){"use strict";function s(e,t,n,s){var o=this;o.my=function(){var s={};s.projects=[],s.tasks={},e.projects.forEach(function(e){s.tasks[e.id]=[],s.projects.push(new t(e.id,e))});for(var o in e.tasks)Object.prototype.hasOwnProperty.call(e.tasks,o)&&e.tasks[o]&&e.tasks[o].length&&e.tasks[o].forEach(function(e){s.tasks[o].push(new n(e.id,e))});return s}(),o.user=s,o.create={project:function(){var e=["Give me a name"],n=Math.floor(Math.random()*e.length);t.create({name:e[n]}).then(function(e){o.my.projects.push(new t(e.id,e)),o.my.tasks[e.id]=[]})},task:function(e,t){return e.taskName.$modelValue&&e.taskName.$modelValue.length?void n.create(t,e.newTask).then(function(s){e.newTask="",e.$setPristine(!0),e.submitted=!1,o.my.tasks[t].length||(o.my.tasks[t]=[]),o.my.tasks[t].unshift(new n(s.id,s))}):void(e.submitted=!0)}},o["delete"]={project:function(e){e["delete"]().then(function(){delete o.my.tasks[e.id];var t=o.my.projects.indexOf(e);t>-1&&o.my.projects.splice(t,1)})},task:function(e){e["delete"]().then(function(){var t=o.my.tasks[e.projectId],n=t.indexOf(e);n>-1&&t.splice(n,1)})}},o.deadlineOpt={"show-weeks":!1},o.dndHandlers={accept:function(e,t){return e.itemScope.sortableScope.$id===t.$id},orderChanged:function(e){var t=e.dest.sortableScope.modelValue,s=t[e.dest.index],o=[];t.forEach(function(){o.push(index)}),n.saveOrder(o,s.projectId)}}}var o=n.module("todo");o.controller("ProjectsCtrl",["my","Project","Task","user",s])}(window,document,window.angular,window.moment);
