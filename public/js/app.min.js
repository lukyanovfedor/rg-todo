...
!function(t,e,n){"use strict";function s(t,e,n,s){var o=this,a=function(t,e){n.saveOrder(t,e)};o.my=function(){var s={};s.projects=[],s.tasks={},t.projects.forEach(function(t){s.tasks[t.id]=[],s.projects.push(new e(t.id,t))});for(var o in t.tasks)Object.prototype.hasOwnProperty.call(t.tasks,o)&&t.tasks[o]&&t.tasks[o].length&&t.tasks[o].forEach(function(t){s.tasks[o].push(new n(t.id,t))});return s}(),o.user=s,o.create={project:function(){var t=["Give me a name"],n=Math.floor(Math.random()*t.length);e.create({name:t[n]}).then(function(t){o.my.projects.push(new e(t.id,t)),o.my.tasks[t.id]=[]})},task:function(t,e){return t.taskName.$modelValue&&t.taskName.$modelValue.length?void n.create(e,t.newTask).then(function(s){var r=[];t.newTask="",t.$setPristine(!0),t.submitted=!1,o.my.tasks[e].length||(o.my.tasks[e]=[]),o.my.tasks[e].unshift(new n(s.id,s)),o.my.tasks[e].forEach(function(t){r.push(t.id)}),a(r,e)}):void(t.submitted=!0)}},o["delete"]={project:function(t){t["delete"]().then(function(){delete o.my.tasks[t.id];var e=o.my.projects.indexOf(t);e>-1&&o.my.projects.splice(e,1)})},task:function(t){t["delete"]().then(function(){var e=o.my.tasks[t.projectId],n=e.indexOf(t);n>-1&&e.splice(n,1)})}},o.deadlineOpt={"show-weeks":!1,"starting-day":1},o.dndHandlers={accept:function(t,e){return t.itemScope.sortableScope.$id===e.$id},orderChanged:function(t){var e=t.dest.sortableScope.modelValue,n=e[t.dest.index],s=[];e.forEach(function(t){s.push(t.id)}),a(s,n.projectId)}}}var o=n.module("todo");o.controller("ProjectsCtrl",["my","Project","Task","user",s])}(window,document,window.angular,window.moment);
